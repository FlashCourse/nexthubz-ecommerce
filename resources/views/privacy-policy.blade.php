    ...
    <section class="bg-orange-100 py-16 text-gray-900">
        <div class="max-w-7xl mx-auto p-4">
            <div class="bg-white p-6 rounded-lg ">
                ...
                <p class="text-sm mb-4">Last updated: July 09, 2024</p>
                ...
                <p class="mb-4">We use Your Personal data to provide and improve the Service. By using the Service, You
                    agree to the collection and use of information in accordance with this Privacy Policy.</p>

                <h2 class="text-xl font-semibold mt-6 mb-2">Interpretation and Definitions</h2>
                <h3 class="text-lg font-semibold mt-4 mb-2">Interpretation</h3>
                ...
                <h3 class="text-lg font-semibold mt-4 mb-2">Definitions</h3>
                <p class="mb-4">For the purposes of this Privacy Policy:</p>
                <ul class="list-disc list-inside mb-4">
                    <li class="mb-2"><strong>Account</strong> means a unique account created for You to access our
                        Service or parts of our Service.</li>
                    <li class="mb-2"><strong>Affiliate</strong> means an entity that controls, is controlled by or is
                    ...
                    <li class="mb-2"><strong>Country</strong> refers to: Bangladesh</li>
                    ...
                    <li class="mb-2"><strong>Personal Data</strong> is any information that relates to an identified
                    ...
                    <li class="mb-2"><strong>Service Provider</strong> means any natural or legal person who processes
                        the data on behalf of the Company. It refers to third-party companies or individuals employed by
                        the Company to facilitate the Service, to provide the Service on behalf of the Company, to
                        perform services related to the Service or to assist the Company in analyzing how the Service is
                        used.</li>
                    <li class="mb-2"><strong>Third-party Social Media Service</strong> refers to any website or any
                        social network website through which a User can log in or create an account to use the Service.
                    </li>
                    <li class="mb-2"><strong>Usage Data</strong> refers to data collected automatically, either
                ...
                <h2 class="text-xl font-semibold mt-6 mb-2">Collecting and Using Your Personal Data</h2>
                <h3 class="text-lg font-semibold mt-4 mb-2">Types of Data Collected</h3>
                <h4 class="text-md font-semibold mt-4 mb-2">Personal Data</h4>
                <p class="mb-4">While using Our Service, We may ask You to provide Us with certain personally
                ...
                <h4 class="text-md font-semibold mt-4 mb-2">Usage Data</h4>
                <p class="mb-4">Usage Data is collected automatically when using the Service.</p>
                <p class="mb-4">Usage Data may include information such as Your Device's Internet Protocol address
                    ...
                    diagnostic data.</p>
                <p class="mb-4">When You access the Service by or through a mobile device, We may collect certain
                ...
                <p class="mb-4">We may also collect information that Your browser sends whenever You visit our Service
                    or when You access the Service by or through a mobile device.</p>
                <h4 class="text-md font-semibold mt-4 mb-2">Information from Third-Party Social Media Services</h4>
                <p class="mb-4">The Company allows You to create an account and log in to use the Service through the
                ...
                <p class="mb-4">If You decide to register through or otherwise grant us access to a Third-Party Social
                    Media Service, We may collect Personal data that is already associated with Your Third-Party Social
                ...
                <p class="mb-4">You may also have the option of sharing additional information with the Company
                    through Your Third-Party Social Media Service's account. If You choose to provide such information
                    and Personal Data, during registration or otherwise, You are giving the Company permission to use,
                    share, and store it in a manner consistent with this Privacy Policy.</p>
                <h4 class="text-md font-semibold mt-4 mb-2">Tracking Technologies and Cookies</h4>
                <p class="mb-4">We use Cookies and similar tracking technologies to track the activity on Our Service
                ...
                <ul class="list-disc list-inside mb-4">
                    <li class="mb-2"><strong>Cookies or Browser Cookies.</strong> A cookie is a small file placed on
                ...
                <p class="mb-4">Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent
                ...
                <p class="mb-4">For more information about the cookies we use and your choices regarding cookies,
                    please visit our Cookies Policy or the Cookies section of our Privacy Policy.</p>
                <h3 class="text-lg font-semibold mt-4 mb-2">Use of Your Personal Data</h3>
                <p class="mb-4">The Company may use Personal Data for the following purposes:</p>
                <ul class="list-disc list-inside mb-4">
                    <li class="mb-2"><strong>To provide and maintain our Service</strong>, including to monitor the
                    ...
                    <li class="mb-2"><strong>To contact You:</strong> To contact You by email, telephone calls, SMS,
                ...
                <ul class="list-disc list-inside mb-4">
                    <li class="mb-2"><strong>With Service Providers:</strong> We may share Your personal information
                        with Service Providers to monitor and analyze the use of our Service, to contact You.</li>
                    <li class="mb-2"><strong>For business transfers:</strong> We may share or transfer Your personal
                    ...
                    <li class="mb-2"><strong>With Affiliates:</strong> We may share Your information with Our
                    ...
                    <li class="mb-2"><strong>With business partners:</strong> We may share Your information with Our
                        business partners to offer You certain products, services or promotions.</li>
                    <li class="mb-2"><strong>With other users:</strong> when You share personal information or
                        ...
                        profile.</li>
                    <li class="mb-2"><strong>With Your consent</strong>: We may disclose Your personal information
                ...
                <p class="mb-4">The Company will take all steps reasonably necessary to ensure that Your data is
                ...
                <h3 class="text-lg font-semibold mt-4 mb-2">Delete Your Personal Data</h3>
                <p class="mb-4">You have the right to delete or request that We assist in deleting the Personal Data
                    that We have collected about You.</p>
                <p class="mb-4">Our Service may give You the ability to delete certain information about You from
                    within the Service.</p>
                <p class="mb-4">You may update, amend, or delete Your information at any time by signing in to Your
                ...
                <p class="mb-4">Please note, however, that We may need to retain certain information when we have a
                ...
                <h3 class="text-lg font-semibold mt-4 mb-2">Security of Your Personal Data</h3>
                ...
                <p class="mb-4">Our Service does not address anyone under the age of 13. We do not knowingly collect
                ...
                <p class="mb-4">If We need to rely on consent as a legal basis for processing Your information and
                ...
                <p class="mb-4">Our Service may contain links to other websites that are not operated by Us. If You
                    click on a third party link, You will be directed to that third party's site. We strongly advise You
                    to review the Privacy Policy of every site You visit.</p>
                <p class="mb-4">We have no control over and assume no responsibility for the content, privacy
                ...
                <p class="mb-4">We may update Our Privacy Policy from time to time. We will notify You of any changes
                    by posting the new Privacy Policy on this page.</p>
                <p class="mb-4">We will let You know via email and/or a prominent notice on Our Service, prior to the
                    change becoming effective and update the &quot;Last updated&quot; date at the top of this Privacy
                    Policy.</p>
                <p class="mb-4">You are advised to review this Privacy Policy periodically for any changes. Changes
