    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white rounded-lg hover:shadow-2xl group">
                ...
                <div class="p-6">
                    <h3 class="text-xl text-green-800 font-semibold mb-2 group-hover:underline">10 Delicious Recipes for
                        Seasonal
                        Fruits</h3>
            ...
            <div class="bg-white rounded-lg hover:shadow-2xl group">
                ...
                <div class="p-6">
                    <h3 class="text-xl text-green-800 font-semibold mb-2 group-hover:underline">How to Store Vegetables
                        to Keep Them
                        Fresh</h3>
        ...
        <div class="flex justify-center mt-12">
            <a href=""
                class="border-2 border-green-500 text-xl text-green-500 hover:bg-green-500 hover:text-white hover:border-green-0 px-4 py-3 rounded-md">Read
