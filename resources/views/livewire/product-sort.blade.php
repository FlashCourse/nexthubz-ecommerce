<div class="flex items-center justify-between mb-6">
    ...
    <!-- Sorting Dropdown -->
    <div class="flex items-center space-x-2">
        <label for="sort" class="hidden md:block text-gray-600">Sort by: </label>
        <select id="sort" name="sort"
            class="text-sm border rounded-md focus:outline-none focus:ring-0 px-8 py-2" wire:model="sortValue"
